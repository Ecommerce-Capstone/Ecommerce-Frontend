            ...
            <div
                ...
                <div
                    ...
                    <div className="text-center">
                        <h2
                            className="text-3xl md:text-4xl font-manrope font-extrabold leading-snug md:leading-tight xl:leading-[1.3em] mb-3 md:mb-4 xl:mb-3 -mt-2 xl:-mt-3 2xl:-mt-4 text-brand-tree-dark xl:text-5xl 2xl:text-[55px]">Healthy
                            vegetable that you deserve to eat fresh
                        </h2>
                        <p className="text-base md:text-[17px] xl:text-lg leading-7 md:leading-8 xl:leading-[1.92em] xl:px-16 text-brand-dark text-opacity-80 2xl:px-32">
                            We source and sell the very best beef, lamb and pork, sourced with the greatest care from
                            farmer.
                        </p>
                            ...
                            <div className="lg:flex">
                                <div className="w-full">
                                    <div className="relative">
                                        <input type="text" className="rounded bg-gray-100 p-4 pl-12 text-base pl-8 w-full"
                                               placeholder="Search" />
